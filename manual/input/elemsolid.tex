...
stress tensor $\boldsymbol{S}$ as output. Right now a hyperelastic- and an elasto-plastic constitutive law are implemented. %% See section ...
...
\begin{tabular}[t]{|c|c|c|c|c|c|c|}
  \hline
  element type & nodes & integration points & order & integration & accelerations & references \tabularnewline
  \hline
  \kw{hexahedron8} & 8 & 8 & 1 & full & yes & \cite{BATHE2016} \tabularnewline
  \hline
  \kw{hexahedron20} & 20 & 27 & 2 & full & no & \cite{BATHE2016} \tabularnewline
  \hline
  \kw{hexahedron20r} & 20 & 8 & 2 & reduced & no & \cite{DHONDT2004} \tabularnewline
  \hline
  \kw{pentahedron15} & 15 & 21 & 2 & full & no & \cite{CODEASTERR30301} \tabularnewline
  \hline
  \kw{tetrahedron10} & 10 & 5 & 2 & full & no & \cite{CODEASTERR30301} \tabularnewline
  \hline
\end{tabular}
\caption{Finite Element Types}
\end{table}
