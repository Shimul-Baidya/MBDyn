...
class Airframe(RotorcraftComponent):
    ...
    def _create_references(self, processor: 'ModelProcessor') -> List[l.Reference]:
        """Creates the reference frame for the airframe."""
        # Use the label assigned by processor during process_model()
        ref = l.Reference(
    ...
    def _create_nodes(self, processor: 'ModelProcessor') -> List[l.Node]:
        """Creates the structural node for the airframe."""
    ...
    def _create_elements(self, processor: 'ModelProcessor') -> List[l.Element]:
        """Creates MBDyn elements for the airframe (currently none)."""
        return []